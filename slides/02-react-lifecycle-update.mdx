...
<ul>
  <Appear>
    <li>componentWillMount → <strong>UNSAFE_componentWillMount</strong></li>
    <li>componentWillRecieveProps → <strong>UNSAFE_componentWillRecieveProps</strong></li>
    <li>componentWillUpdate → <strong>UNSAFE_componentWillUpdate</strong></li>
  </Appear>
</ul>
...
<ul>
  <Appear>
    <li><strong>getDerivedStateFromProps</strong> >=16.3.0</li>
    <li><strong>getSnapshotBeforeUpdate</strong> >= 16.3.0</li>
    <li><strong>getDerivedStateFromError</strong> >= 16.6.0</li>
  </Appear>
</ul>
...
<Notes>
Here inside Lifecycle diagram we can see old 3 lifecycle methods and 3 new ones.
